    ...
    488: (e, n, t) => {
      ...
      var r,
          ...
          (n = n || {}),
            S(function () {
              ...
              if (a) {
                ...
                var c = g(function () {
                  J[i.id] ||
                    (o(a.takeRecords()), a.disconnect(), (J[i.id] = !0), t(!0));
                });
        ...
        V = function (e, n) {
          n = n || {};
          var t = l("TTFB"),
            r = v(e, t, Q, n.reportAllChanges);
          U(function () {
            var i = f();
            i &&
              ((t.value = Math.max(i.responseStart - d(), 0)),
              (t.entries = [i]),
              r(!0),
              s(function () {
                (t = l("TTFB", 0)), (r = v(e, t, Q, n.reportAllChanges))(!0);
              }));
          });
        },
        ...
        Y = function (e, n) {
          i ||
            ((i = n), (o = e), (a = new Date()), ee(removeEventListener), Z());
        },
        Z = function () {
          if (o >= 0 && o < a - X) {
            var e = {
...
//# sourceMappingURL=488.e75445ad.chunk.js.map
